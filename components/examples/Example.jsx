...
class Example extends React.Component {
  ...
  handleButtonClick(buttonName, event) {
    ...
    updateMotto() {
        // Check if inputValue is not empty before updating the motto
      ...
      <div className="container Example">
        <h1>Project 4 React.js Example</h1>
          ...
          <div className="motto-update">
              <p className="name">Your name: {this.state.name}</p>
              <p className="motto">Your Short Motto (up to 20 characters): {this.state.motto}</p>

              <input
                  type="text"
                  placeholder="Enter a new motto"
                  value={this.state.inputValue}
                  onChange={this.handleChangeBound}
              />
              <button onClick={() => this.updateMotto()}>Update Motto</button>
